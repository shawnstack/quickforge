...
/**
 * Multi-store key-value storage abstraction. Can be implemented by
 * IndexedDB, HTTP-backed services, or any other multi-collection storage.
 */
export interface StorageBackend {
  ...
  /** Get storage quota information. Used for warning users when approaching limits. */
...
export interface SessionMetadata {
  ...
  /** Preview text for search and display (last assistant message text, truncated to 200 chars; see server previewFromMessages). */
  preview: string
}
...
/** Configuration for IndexedDB-style object stores. */
