...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-1.3.16-blue" />
...
```bash
npm install -g @shawnstack/quickforge@1.3.16
qf
...
```text
package-offline/shawnstack-quickforge-1.3.16.tgz
```
...
该包由 `v1.3.16` 标签生成，包含离线安装所需的运行时依赖。
...
The offline release package for `v1.3.16` is:
...
The package was generated from tag `v1.3.16` and includes bundled runtime dependencies for offline installation.
