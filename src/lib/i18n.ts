...
export const appTranslations = {
  en: {
    ...
    skillsDescription: 'Select the reusable skills enabled for project "{project}". Enabled skills are injected into new project chat instructions.',
  ...
  zh: {
    ...
    skillsDescription: '选择项目「{project}」启用的可复用技能。启用后会注入到新的项目对话指令中。',
    searchSkills: '搜索技能...',
