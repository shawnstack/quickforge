...
```bash
npm install -g @shawnstack/quickforge@1.3.3
qf
...
```text
package-offline/shawnstack-quickforge-1.3.3.tgz
```
...
该包由 `v1.3.3` 标签生成，包含离线安装所需的运行时依赖。
...
The offline release package for `v1.3.3` is:
...
The package was generated from tag `v1.3.3` and includes bundled runtime dependencies for offline installation.
