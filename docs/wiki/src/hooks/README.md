...
| Hook 文件 | 行数 | 用途 |
|-----------|------|------|
| [useAppBootstrap.ts](../../src/hooks/useAppBootstrap.ts) | 174 | 应用启动引导：初始化 Storage、加载项目、恢复会话 |
| [useAgentManager.ts](../../src/hooks/useAgentManager.ts) | 400 | Agent 生命周期管理：创建、加载、切换会话 |
| [useChatActions.ts](../../src/hooks/useChatActions.ts) | 276 | 聊天操作：发送消息、回滚、分叉、复制 |
...
| [useCrossTabSync.ts](../../src/hooks/useCrossTabSync.ts) | 90 | 跨标签页同步 |
| [useSentinel.ts](../../src/hooks/useSentinel.ts) | 42 | 哨兵元素（用于 Infinite Scroll） |
| [useTaskToasts.ts](../../src/hooks/useTaskToasts.ts) | 34 | 后台任务 Toast 通知管理 |
| [useVisibleRuntimeStatuses.ts](../../src/hooks/useVisibleRuntimeStatuses.ts) | 94 | 可见会话的后台任务状态轮询 |

---

## 核心 Hooks 说明

### useAppBootstrap.ts (174 行)
