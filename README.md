...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-1.3.5-blue" />
...
```bash
npm install -g @shawnstack/quickforge@1.3.5
qf
...
```text
package-offline/shawnstack-quickforge-1.3.5.tgz
```
...
该包由 `v1.3.5` 标签生成，包含离线安装所需的运行时依赖。
...
The offline release package for `v1.3.5` is:
...
The package was generated from tag `v1.3.5` and includes bundled runtime dependencies for offline installation.
