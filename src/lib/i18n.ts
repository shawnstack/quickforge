...
export const appTranslations = {
  en: {
    ...
    backupRestoreDescription: 'Export or restore QuickForge settings, providers, projects, scheduled tasks, and conversations. Imports create a safety backup on the local service before writing data.',
    exportData: 'Export data',
    exportDataDescription: 'Download a JSON backup that you can keep or move to another QuickForge installation.',
    ...
    importDataDescription: 'Restore a previously exported JSON backup. Matching sections in the current local data will be replaced.',
  ...
  zh: {
    ...
    requestFailed: '请求失败',
    backupRestore: '备份与恢复',
    backupRestoreDescription: '导出或恢复 QuickForge 的设置、模型提供商、项目、定时任务和对话。导入前本地服务会先创建一份安全备份。',
    exportData: '导出数据',
    exportDataDescription: '下载 JSON 备份文件，可自行保存或迁移到其他 QuickForge 安装。',
    exportScope: '导出范围',
    exportScopeAll: '全部数据',
    ...
    importData: '导入数据',
    importDataDescription: '恢复之前导出的 JSON 备份。当前本地数据中对应的部分会被替换。',
    importBackup: '导入备份',
