...
│   ├── GitToolsPinnedSummary.tsx   # 顶部 List 常驻；桌面 closed/capsule/panel 三态可拖动摘要，胶囊用 Maximize2 弱提示展开，移动端固定两态 List 弹层；Git 工具、任务清单与智能体双小节
