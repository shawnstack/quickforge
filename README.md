...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-1.3.29-blue" />
...
```bash
npm install -g @shawnstack/quickforge@1.3.29
qf
...
```text
package-offline/shawnstack-quickforge-1.3.29.tgz
```
...
该包由 `v1.3.29` 标签生成，包含 QuickForge 运行时资源，依赖由 npm 安装。
...
The offline release package for `v1.3.29` is:
...
The package was generated from tag `v1.3.29` and includes QuickForge runtime assets and installs dependencies with npm.
