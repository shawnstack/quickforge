...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-1.3.24-blue" />
...
```bash
npm install -g @shawnstack/quickforge@1.3.24
qf
...
```text
package-offline/shawnstack-quickforge-1.3.24.tgz
```
...
该包由 `v1.3.24` 标签生成，包含 QuickForge 运行时资源，依赖由 npm 安装。
...
The offline release package for `v1.3.24` is:
...
The package was generated from tag `v1.3.24` and includes QuickForge runtime assets and installs dependencies with npm.
