...
export const appTranslations = {
  en: {
    ...
    defaultOptionsDescription: 'Configure the default model and thinking level for new chats and scheduled tasks.',
  ...
  zh: {
    ...
    defaultOptions: '默认选项',
    defaultOptionsDescription: '配置新建对话和定时任务默认使用的模型与思考等级。',
    defaultModel: '默认模型',
