...
```bash
npm install -g @shawnstack/quickforge@1.5.7
qf
...
该包由 `v1.5.7` 标签生成，包含 QuickForge 运行时资源，依赖由 npm 安装。
...
The offline release package for `v1.5.7` is:
...
The package was generated from tag `v1.5.7` and includes QuickForge runtime assets and installs dependencies with npm.
