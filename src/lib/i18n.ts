...
export const appTranslations = {
  en: {
    ...
    globalSkillsDescription: 'Select reusable Agent Skills enabled globally for QuickForge. Skills are read from bundled skills, ~/.agents/skills, and ~/.quickforge/skills. Only the catalog is injected into new chats; instructions load on demand.',
  ...
  zh: {
    ...
    globalSkillsDescription: '选择 QuickForge 全局启用的 Agent Skills。技能会从内置 skills、~/.agents/skills 和 ~/.quickforge/skills 读取。新对话只注入目录，完整指令按需加载。',
