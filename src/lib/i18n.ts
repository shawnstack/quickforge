...
const appTranslations = {
  en: {
    ...
    andMoreModels: 'and {count} more',
    cancel: 'Cancel',
    save: 'Save',
    loading: 'Loading...',
    noCustomModels: 'No custom models yet. Click “Add model”.',
    fillProviderBaseUrlModel: 'Please fill in provider name, Base URL, and model ID.',
  ...
  zh: {
    ...
    model: '模型',
    noModelAdded: '未添加模型',
    andMoreModels: '等 {count} 个',
    cancel: '取消',
    save: '保存',
    loading: '加载中...',
    noCustomModels: '还没有自定义模型，请点击“添加模型”。',
    fillProviderBaseUrlModel: '请填写提供商名称、Base URL 和模型 ID。',
